...
from .views import VendorList,VendorDetails,ProductsList,ProductDetails,CustomerList,CustomerDetails,OrderDetails,OrderList,CustomerAddressViewSet,ProductRatingViewSet,ProductCategoryViewSet
